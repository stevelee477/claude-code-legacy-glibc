...
```bash
curl -fsSL https://raw.githubusercontent.com/stevelee477/alpine-claude-code/main/install.sh | bash
```
...
The GitHub Actions workflow checks npm for new Claude Code releases every 6 hours and automatically builds & publishes a new release.
